                    ...
                    >
                      <div className="flex items-center gap-2  cursor-pointer">
                        <img
                          ...
                          className="h-[24px] w-[24px]"
                        />
                        <p className="text-[14px] text-white">Copy message</p>
                      </div>
                      <div className="flex items-center gap-2 bg-[#2B2E30] -ml-1 px-2 w-[170px] h-[40px] cursor-pointer rounded-[8px] ">
                        <img
                          ...
                          className="h-[24px] w-[24px]"
                        />
                        <p className="text-[14px] text-white">Report message</p>
                      </div>
                      <div
                      ...
                      >
                        <img
                          ...
                          className="h-[24px] w-[24px]"
                        />
                        <p className="text-[14px] text-white">Remove message</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex justify-between">
                <div className="flex items-center space-x-4">
                  <img
                    ...
                    className="h-[32px] w-[32px] rounded-full"
                  />
                  <p className="text-[16px] text-[#FAFBFC]">Jane Cooper</p>
                  <p className="text-[14px] text-[#7D8185]">10:50 am</p>
                </div>
                <div className="flex items-center space-x-2"></div>
              </div>
              <Button disabled className="ml-[47px] text-[14px] w-[146px] h-[36px] bg-[#212426] rounded-md text-center text-[#FAFBFC]  ">
                Message removed
              </Button>
            </div>
